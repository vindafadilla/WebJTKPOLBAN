        ...
        <form name="myForm" method="POST" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
                <label for="id" class="col-md-6 control-label">Username (NIM)</label>
                <div class="col-md-6">
             ...
             <div class="form-group">
                  <label for="judulinfo" class="col-md-6 control-label">Password</label>
                  <div class="col-md-6">
            ...
            <div class="form-group">
                  <label for="tgl" class="col-md-6 control-label">Kelas</label>
                  <div class="col-md-6">
            ...
            <div class="form-group">
                  <label for="tgl" class="col-md-6 control-label">Email</label>
                  <div class="col-md-6">
